...
const textAreaStyles = cva(
  'bg-neutral peer h-32 w-full rounded-lg border px-4 py-3.5 text-neutral-800 placeholder:text-neutral-400 focus:ring-4 disabled:border-neutral-200 disabled:bg-neutral-50 disabled:text-neutral-300 disabled:placeholder:text-neutral-300',
  {
    variants: {
      state: {
        default:
