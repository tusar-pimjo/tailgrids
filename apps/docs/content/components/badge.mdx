...
Use the Badge component to highlight status, counts, or small metadata labels with semantic colors and icons for clear visual emphasis and categorization.
